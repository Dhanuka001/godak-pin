    ...
    <section className="relative text-white pb-10 overflow-hidden">
      ...
      <div className="container-fixed py-10 relative z-10">
        <div className="space-y-6 text-center max-w-3xl mx-auto">
          <div>
            <h1 className="text-3xl md:text-4xl font-semibold leading-tight">{t('hero.title')}</h1>
            <p className="mt-3 text-white/80">{t('hero.description')}</p>
        ...
        >
            ...
            >
                <option value="">{t('hero.search.district')}</option>
              {districtNames.map((d) => (
            ...
            >
              <option value="">{t('hero.search.category')}</option>
